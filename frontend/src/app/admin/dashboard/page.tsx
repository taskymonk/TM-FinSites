...
import { Shield, LogOut, FileText, Users, BarChart3, Mail, Loader2, Search, RefreshCw, ChevronDown } from "lucide-react"
import { toast } from "sonner"
import { getAdminSession, adminLogout, getAdminStats, getSubmissions, updateSubmissionStatus } from "@/lib/admin-actions"
...
export default function AdminDashboard() {
  ...
  async function loadData() {
    ...
    const [statsResult, subsResult] = await Promise.all([getAdminStats(), getSubmissions()])
